...
const contractABI = sails.config.custom.contractABIRsk;
const contractAddress = sails.config.custom.contractAddressRsk;
const privateKey = Buffer.from(
  sails.config.custom.privateKeyRsk,
  'hex',
);
  ...
  stamp : async function (req, res){
	  	...
	  	web3.eth.getTransactionCount(accountAddress, (err, txCount) => {
			...
			const txObject = {
				...
				gasPrice: web3.utils.toHex(web3.utils.toWei('100000000', 'wei')),
				data: data
			}
